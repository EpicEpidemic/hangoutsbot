...
def getplaces(location, clid, secret, section=None):
    url = "https://api.foursquare.com/v2/venues/explore?client_id={}&client_secret={}&limit=10&v=20160503&near={}".format(
        clid, secret, location)
    ...
    for location in data['response']['groups'][0]['items']:
        mapsurl = "http://maps.google.com/maps?q={},{}".format(location['venue']['location']['lat'],
                                                               location['venue']['location']['lng'])
        places.append("<b><u><a href='{}'>{}</a></b></u> (<a href='{}'>maps</a>)<br>Score: {}/10 ({})".format(mapsurl,
                                                                                                              location[
                                                                                                                  'venue'][
                                                                                                                  "name"],
                                                                                                              "http://foursquare.com/v/{}".format(
                                                                                                                  location[
                                                                                                                      'venue'][
                                                                                                                      'id']),
                                                                                                              location[
